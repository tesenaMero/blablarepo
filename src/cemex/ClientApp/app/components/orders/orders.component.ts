...
export class OrdersComponent implements OnInit {
    ...
    initOrders() {
        this.columns = [
            ...
            { name: "t.pt('views.table.order_no')", width: 15 },
            { name: "t.pt('views.table.submitted')", width: 15 },
            { name: "t.pt('views.table.location')", width: 25 },
            { name: "t.pt('views.table.pon')", width: 15 },
            { name: "t.pt('views.table.products')", width: 10 },
            { name: "t.pt('views.table.amount')", width: 10, sortable: false },
            { name: "t.pt('views.table.request_date')", width: 20 },
            { name: "t.pt('views.table.status')", width: 18 },
            { name: "t.pt('views.table.total')", width: 13 },
        ]
