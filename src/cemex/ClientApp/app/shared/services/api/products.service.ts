...
export class ProductsApi {
    ...
    fetchReadymixContracts(jobsite, salesDocumentTypeId, productLine, shippingCondition): Observable<Response> {
        // '/v2/mm/myproducts?salesDocumentTypeId=1&shippingConditionId=1&shipmentLocationId=815.2&productId=1536'
        return this.api.get(`/v2/mm/myproducts?salesDocumentTypeId=${salesDocumentTypeId}&shippingConditionId=${shippingCondition.shippingConditionId}&shipmentLocationId=${jobsite.shipmentLocationId}.2`);
    }
